# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 20:44:57 2020

@author: ragha
## Thanks to Jamess Jackson for the code
"""
...
class Map():
    def __init__(self, xsize, ysize, grid_size):
        ...
        self.beta = 5.0*np.pi/180.0 # The assumed width of the laser beam. Here assumed as 5deg and converting into radian
